...
insert into books(title,publisher) values("The C Programming Language",1),("The Go Programming Language",1),("The UNIX Programming Environoment",1),("Cryptonomicon",2),("Deep Work",3),("Atomic Habits",4),("The City and The City",5),("The Great War for Civilisation",6);
